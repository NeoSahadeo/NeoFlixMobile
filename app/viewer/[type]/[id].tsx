        ...
        ;(async () => {
            try {
                if (type === 'tv') {
                    ...
                    const r = (await sonarrApi.series.lookup(
                        'tmdb:' + id
                    )) as any
                ...
                <ScrollView>
                    <View className="flex gap-2 items-center mb-10">
                        ...
                        <View className="flex-1 flex flex-row justify-around gap-10">
                            ...
                            <Text className="text-gray-400 text-lg font-black">
                                {localData.statistics.seasonCount}{' '}
                                {localData.statistics.seasonCount > 1
                                    ? 'Seasons'
                                    : 'Season'}
                            </Text>
                        </View>
                                                            ...
                                                            const r =
                                                                await axios({
                                                                    ...
                                                                    headers: {
                                                                        ...
                                                                        'X-Api-Key':
                                                                            sonarrApi.sonarr_api_key,
                                                                    },
                                                                })
                                                            const x =
                                                                (await sonarrApi.series.lookup(
                                                                    'tmdb:' + id
                                                                )) as any
                                                            if (x) {
                                                                setLocalData(
                                                    ...
                                                    onPress={async () => {
                                                        try {
                                                            if (localData.id) {
                                                                ...
                                                                localData.rootFolderPath =
                                                                    rootFolderPath.data[0].path
